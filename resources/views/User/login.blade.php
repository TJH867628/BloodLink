...
<body class="d-flex flex-column flex-lg-row min-vh-100">
    ...
    <div class="col-lg-6 auth-left p-5 d-flex flex-column justify-content-between position-relative">
        ...
        <div>
            <h1 class="display-4 fw-black">Welcome Back to the Lifeline.</h1>
            <p class="text-white-50">Access your dashboard to manage donation, inventory, or coordinate events.</p>
        </div>
    ...
    <div class="col-lg-6 d-flex align-items-center justify-content-center p-4 position-relative">
        ...
        <div style="max-width: 420px; width:100%;">
            <h2 class="fw-black mb-2">Sign In</h2>
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <p class="text-center small">
                    New to BloodLink?
                    <a href="{{ route('register') }}" class="text-brand fw-bold">Create an account</a>
                </p>
            </form>
        </div>
    </div>
